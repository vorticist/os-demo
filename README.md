...
But setting up a AI workflow environment in a more private infrastructure is not excactly easy, the 'as a service' experience abstracts much of what's needed to setup an environment in order to provide a streamlined user experience. 
